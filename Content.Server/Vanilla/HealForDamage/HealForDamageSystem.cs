...
public sealed partial class HealForDamageSystem : EntitySystem
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<HealForDamageComponent, DamageChangedEvent>(HealOnDamage);
    }

    private void HealOnDamage(EntityUid uid, HealForDamageComponent heal, DamageChangedEvent args)
    {
