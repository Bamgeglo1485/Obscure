ghost-role-information-sentient-hostile-rules =
    You are a [color={ role-type-solo-antagonist-color }][bold]{ role-type-solo-antagonist-name }[/bold][/color]. While you are now sapient and capable of rationalizing, you are still hostile to the station's personnel, and are [color=red]NOT[/color] permitted to be "friendly" or ally with them.
