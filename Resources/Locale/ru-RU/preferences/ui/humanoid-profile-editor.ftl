...
humanoid-profile-editor-randomize-skin-button = Тон кожит
...
humanoid-profile-editor-randomizer-lock-tooltip = Блокирует от рандомизации
...
humanoid-profile-editor-voice-none = Неименованный
