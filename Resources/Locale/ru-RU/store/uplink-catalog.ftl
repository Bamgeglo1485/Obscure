...
uplink-l6-saw-bundle-desc = Культовый ручной пулемёт L6 в комплекте с 2 коробами патронов.
...
uplink-business-card-name = Визитная карточка НаноТрейзен
uplink-business-card-desc = Визитная карточка, которую можно передать кому-нибудь, чтобы показаться очень важным. Вы можете приобрести не более трёх таких визиток.
